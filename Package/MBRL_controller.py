...
class jey_MBRL():
    ...
    # Data normalization    
    def Normalizing_data(self, x_tr, y_tr, action_norm_):
        ...
        return x_train_, y_train_, xy_norm
    ...
    def joint_states_callback(self, wrench, joint_position, joint_velocity):
        ...
        # self.tictoc.tic()
        self.best_u_sequence = self.CEM_norm_p(self.x, self.action_dim, self.prediction_horizon, self.samples_num, self.training_dict['xy_norm'], self.NN_ensemble, self.ensemble_size)
...
if __name__=='__main__':
    ...
    print_loss = True
    dx = yn_train.shape[1]
    du = xn_train.shape[1] - yn_train.shape[1]
